...
- ✅ 10 eval:29 条 golden set,5 次采样 **precision 1.00 / recall 1.00**,27 条完全稳定(09-17)
  ...
  #10 #12 是真边界(0~2/5 之间来回),改 prompt 时要盯着
...
- `PostDetailViewController.swift` 无人引用(详情早已改成广场页内展示),可删
